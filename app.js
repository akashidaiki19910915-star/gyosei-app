...
const PERMIT_SCENARIO_MASTER = {
  ...
  zairyu_koshin: { label: "在留期間更新許可申請", docs: ["申請書", "在留カード写し", "パスポート写し", "在職・在学証明資料", "課税・納税関係資料"], tasks: ["申請取次資格確認", "更新要件確認", "必要書類回収", "申請書作成", "入管提出・補正対応"] },
  sozoku_initial: { label: "相続手続 初回ヒアリング", docs: ["被相続人情報メモ", "相続人関係図案", "遺言書有無確認資料", "財産一覧メモ", "戸籍収集状況メモ"], tasks: ["初回ヒアリング", "戸籍収集方針確認", "財産調査範囲確認", "必要書類案内", "司法書士連携要否確認"] },
...
const WORK_TYPE_FIELD_SCHEMA = {
  ...
  construction: [
    ...
    { name: "permitEngineerCandidate", label: "専任技術者", type: "text" },
    { name: "permitOfficeCount", label: "営業所数", type: "number", min: 1, value: 1 },
  ],
  takken: [
    { name: "permitGovernorType", label: "知事/大臣", type: "select", options: [{ value: "知事", label: "知事" }, { value: "大臣", label: "大臣" }] },
    { name: "permitOfficeCount", label: "営業所数", type: "number", min: 1, value: 1 },
    { name: "permitQualifiedCount", label: "有資格者人数", type: "number", min: 0, value: 0 },
  ...
  company_establishment: [
    ...
    { name: "permitTradeName", label: "商号", type: "text" },
    { name: "permitHeadOfficeAddress", label: "本店所在地", type: "text" },
    { name: "permitPurpose", label: "事業目的", type: "text" },
    { name: "permitCapitalAmount", label: "資本金", type: "number", min: 0 },
    { name: "permitDirectorStructure", label: "役員構成", type: "text" },
    { name: "permitPublicNoticeMethod", label: "公告方法", type: "text" },
    { name: "permitArticlesPrepared", label: "定款作成", type: "select", options: [{ value: "済", label: "済" }, { value: "未", label: "未" }] },
    { name: "permitNeedNotary", label: "公証人認証要否", type: "select", options: [{ value: "要", label: "要" }, { value: "不要", label: "不要" }] }
  ],
  startup_finance: [
    { name: "permitLoanAmount", label: "希望融資額", type: "number", min: 0 },{ name: "permitOwnFund", label: "自己資金", type: "number", min: 0 },{ name: "permitStartupTiming", label: "創業時期", type: "text" },{ name: "permitBusinessExperience", label: "事業経験", type: "text" },{ name: "permitFundUse", label: "資金使途", type: "text" },{ name: "permitRepaymentSource", label: "返済原資", type: "text" },{ name: "permitSalesForecast", label: "売上見込み", type: "text" },{ name: "permitHasBusinessPlan", label: "事業計画書有無", type: "select", options: [{ value: "あり", label: "あり" }, { value: "なし", label: "なし" }] }
  ],
  sangyo_unpan: [
    { name: "permitApplicantTypeBusiness", label: "法人/個人", type: "select", options: [{ value: "法人", label: "法人" }, { value: "個人", label: "個人" }] },{ name: "permitOfficerMembers", label: "役員", type: "text" },{ name: "permitCourseCertificate", label: "講習会修了証", type: "select", options: [{ value: "あり", label: "あり" }, { value: "なし", label: "なし" }] },{ name: "permitTransportVehicles", label: "運搬車両", type: "text" },{ name: "permitTransferStorage", label: "積替保管の有無", type: "select", options: [{ value: "あり", label: "あり" }, { value: "なし", label: "なし" }] },{ name: "permitTransportItems", label: "取り扱う産廃種類", type: "text" },{ name: "permitWorksiteAddress", label: "事業場所在地", type: "text" }
  ],
  zairyu: [
    { name: "permitApplicationKind", label: "申請種別", type: "text" },{ name: "permitNationality", label: "国籍", type: "text" },{ name: "permitResidenceCard", label: "在留カード", type: "select", options: [{ value: "あり", label: "あり" }, { value: "なし", label: "なし" }] },{ name: "permitPassport", label: "パスポート", type: "select", options: [{ value: "あり", label: "あり" }, { value: "なし", label: "なし" }] },{ name: "permitActivity", label: "活動内容", type: "text" },{ name: "permitContractRelation", label: "雇用契約", type: "text" },{ name: "permitHostOrg", label: "受入機関", type: "text" },{ name: "permitReasonLetter", label: "理由書", type: "select", options: [{ value: "あり", label: "あり" }, { value: "なし", label: "なし" }] }
  ],
  inheritance: [
...
function mapPermitHearingToEstimateCalc(hearing, linkedCase) {
  ...
  return {
    ...
    keikan_level: String(dynamic.permitKeikanLevel || "").includes("高") ? "高" : (String(dynamic.permitKeikanLevel || "").includes("中") ? "中" : "低"),
